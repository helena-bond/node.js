...
function updateUser(event) {
    ...
    if(errorCount === 0) {
        ...
        // If it is, compile all user info into one object
        var updateUser = {
            'username': $('input#updateUserName').val(),
            'email': $('input#updateUserEmail').val(),
            'fullname': $('input#updateUserFullname').val(),
            'age': $('input#updateUserAge').val(),
            'location': $('input#updateUserLocation').val(),
            'gender': $('input#updateUserGender').val()
        }
